...
// 2️⃣ Meal filter (FROM filteredItems)
...
const reportMeals = reportItems.length;
  ...
  // Content
  doc.setFontSize(14);
  doc.text(`🔥 Calories: ${reportCalories} kcal`, 20, 55);
  doc.text(`💪 Protein: ${reportProtein.toFixed(1)} g`, 20, 65);
  doc.text(`🍽️ Meals Logged: ${reportMeals}`, 20, 75);
